...
import { MapInfo, MapImage, LayerGroup, TileLayer, QuadLayer, TilemapLayerType, Tile, TileId, TeleTile, SpeedupTile, SwitchTile, TuneTile, Quad, QuadPoint, QuadColor } from "@twlibn/types";
